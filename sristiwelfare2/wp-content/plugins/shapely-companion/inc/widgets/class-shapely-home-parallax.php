...
class Shapely_Home_Parallax extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		$class6 = ( 'left' == $instance['image_pos'] ) ? 'col-md-7 col-sm-6 text-center mb-xs-24 image' : '';
						...
						<div class="<?php echo esc_attr( $class4 ); ?>">
							...
							if ( ( 'left' == $instance['image_pos'] || 'top' == $instance['image_pos'] ) && '' != $instance['image_src'] ) {
								...
								<div class="<?php echo esc_attr( $class6 ); ?>">
									<img class="img-responsive img" alt="<?php echo esc_attr( $instance['title'] ); ?>" src="<?php echo esc_url( $instance['image_src'] ); ?>">
								</div>
								<?php
							}
							?>
