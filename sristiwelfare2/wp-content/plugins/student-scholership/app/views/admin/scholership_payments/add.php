...
<?php echo $this->form->input('payment_approval_date',array('type' => 'date')); ?>
<?php echo $this->form->input('payment_approved_by'); ?>
<?php echo $this->form->input('payment_disbursment_date',array('type' => 'date')); ?>
